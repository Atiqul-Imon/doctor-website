        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Family Medicine</p>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/appointment" className="text-gray-400 hover:text-sky-400 transition-colors">
                  Book Appointment
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <span className="text-gray-400">General Checkups</span>
              </li>
              <li>
                <span className="text-gray-400">Preventive Care</span>
              </li>
              <li>
                <span className="text-gray-400">Chronic Disease Management</span>
              </li>
              <li>
                <span className="text-gray-400">Vaccinations</span>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <MapPinIcon className="h-5 w-5 text-sky-400 mt-0.5 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:info@drsarahjohnson.com" className="text-gray-400 hover:text-sky-400 transition-colors">
                  info@drsarahjohnson.com
                </a>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2 text-gray-400 text-sm">
              ...
              <span>Made with care for your health and well-being</span>
            </div>
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-sm text-gray-400">
              <p>&copy; {currentYear} Dr. Sarah Johnson. All rights reserved.</p>
              <div className="flex space-x-4">
